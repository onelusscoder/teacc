...
#   ifdef TEASCRIPT_EXPORT
#       define TEASCRIPT __declspec(dllexport)
#       if __GNUC__ >= 4
#           define TEASCRIPT __attribute__ ((visibility ("default")))
...
#       endif
#   else
#       define TEASCRIPT __declspec(dllimport)
#   endif
#   else
#       define TEASCRIPT    // Not ms-Windows/MSVC
#endif
